...
Less - Pré-processador CSS que permite o uso de variáveis, aninhamento e outras funcionalidades avançadas.
Instalação
...
Run
Copy code
git clone https://github.com/alderighi1979/exercicio_less.git
...
Para compilar os arquivos Less em CSS, utilize o seguinte comando:

bash
Run
Copy code
npm run build
Depois de compilar, abra o index.html em um navegador para visualizar o resultado.
